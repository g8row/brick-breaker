        ...
        public Grid() {
                for (int i = 0; i < brickgrid.length; i++) {
                        for (int j = 0; j < brickgrid[i].length; j++) {
                                if (j < 4) {
                                        brickgrid[i][j] = new Brick(i * Brick.WIDTH + GUI.WIDTH_OFFSET,
                                                        j * Brick.HEIGHT + GUI.HEIGHT_OFFSET, 1);
                                        if (j == 3) {
                                                Brick coordinates = new Brick(i * Brick.WIDTH + GUI.WIDTH_OFFSET,
                                                                j * Brick.HEIGHT + GUI.HEIGHT_OFFSET, 1);
                                        ...
                                        brickgrid[i][j] = new Brick(i * Brick.WIDTH + GUI.WIDTH_OFFSET,
                                                        j * Brick.HEIGHT + GUI.HEIGHT_OFFSET, 0);
                                }
                        }
                }
        }
